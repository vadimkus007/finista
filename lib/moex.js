...
class Moex {
    ...
    static getHistory(secid, boards, markets, cb) {
        let baseURL = `http://iss.moex.com/iss/history/engines/stock/markets/${markets}/boards/${boards}/securities/${secid}.json?iss.meta=off&history.columns=TRADEDATE,CLOSE`;
